...
if len(sys.argv) != 4:
    ...
    print("resource_type_plural: projects | inventories | credentials | job_templates | execution_environments | inventory_sources | organizations | users | hosts | groups")
    sys.exit(1)
...
if resource_type == "projects":
    ...
    print("Unsupported resource_type. Use: project | inventory | credential | job_template")
    sys.exit(1)
